...
public class RegistrarEgresoController implements Initializable {
    ...
    private void registrarEgreso(ActionEvent event) {
        ...
        if (this.txt_motivoRegistrar.getText().isEmpty()
            ...
            try {
                ...
                params.put("motivo", this.txt_motivoRegistrar.getText());
                ...
                Logger.getLogger(RegistrarEgresoController.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
